# macOS_notes_app_example
An example Notes app for macOS built with SwiftUI and SwiftData, focused on state management, persistent storage, and scalable app architecture.

## Features
- Key feature 1 (what it does for the user)
- Key feature 2 (what it does for the user)
- Key feature 3 (what it does for the user)
